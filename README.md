...
A console based Area Calculator for Shapes. The following topics are covered: `floats`, `Maths Class`, `Local Functions` and `Conditional Statements`.
